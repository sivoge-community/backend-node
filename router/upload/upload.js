...
const app        = express('')
const {conexion} = require("../../mysql/mysql");
const Papa       = require("papaparse");
const fs         = require('fs');

app.use(fileUpload({useTempFiles: true}));

app.put('/upload',conexion,(req,res)=>{
    ...
    var myarray=[];
      ...
      Papa.parse(content, {
          ...
          step: function(row){
                ...
                vectAux.push(row.data['DOC'].toString(),typeIden[0],nombre.toLowerCase(),apellido.toLowerCase(),row.data['JORNADA'].toString().toLowerCase(),row.data['GRADO'].toLowerCase(),grupo);
          ...
          complete: function(results,file) {
              console.log(results);
                ...
                let query = 'INSERT INTO `user`(`doc_id`,`document_type`,`name`,`lastname`,`daytime`,`grade`,`group`) VALUES ?';
